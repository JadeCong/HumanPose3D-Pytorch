...
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../../.."))
from hpn.datasets.dataset_human36m import Human36MMultiViewDataset
...
while True:
    ...
    from hpn.utilities.multiview import project_3d_points_to_image_plane_without_distortion as project
